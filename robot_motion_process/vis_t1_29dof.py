...
def main(cfg : DictConfig) -> None:
    ...
    humanoid_xml = "./description/robots/t1/t1_29dof.xml"
    print(humanoid_xml)
    ...
    if not vis_smpl:
        cfg_robot = OmegaConf.load("description/robots/t1/phc_t1_29dof.yaml")
    ...
    with mujoco.viewer.launch_passive(mj_model, mj_data, key_callback=key_call_back) as viewer:
        ...
        while viewer.is_running():
            ...
            if vis_smpl:
                ...
                # Update for T1 29DOF (29 joints instead of 23)
                for i in range(29):
